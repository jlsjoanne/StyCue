...
namespace Stycue.Api.Controllers
{
    ...
    /// </summary>
    /// <remarks>
    /// 提供委託文詳情查詢、建立、提前關閉、到期後補充並重新開啟，以及加碼積分功能
    /// 委託文不提供一般編輯與刪除；生命週期由 Close、Repost、Boost 與獎勵結算流程處理
    /// </remarks>
    ...
    public class CommissionController : ControllerBase
    {
        ...
        private IActionResult ToActionResult<T>(ApiResponse<T> result)
        {
            ...
            return result.ErrorCode switch
            {
                ...
                "COMMISSION_BOOST_FAILED" => StatusCode(StatusCodes.Status500InternalServerError, result),
